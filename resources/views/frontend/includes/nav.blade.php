    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuUser">
                    <a href="{{ route('frontend.blog.index', 'penmanship-2019') }}" class="dropdown-item {{ active_class(Request::is('blog/penmanship-2019')) }}">Penmanship 2019</a>
                    <a href="{{ route('frontend.blog.index', 'penmanship-2020') }}" class="dropdown-item {{ active_class(Request::is('blog/penmanship-2020')) }}">Penmanship 2020</a>
                </div>
            </li>
