        ...
        <div class="container">
            ...
            <div class="customNavigation clearfix mb-1">
                <div class="btn-group float-right">
                    <button type="button" class="btn btn-outline-secondary customPrevBtn"><i class="fas fa-angle-left"></i></i></button>
                    <button type="button" class="btn btn-outline-secondary customNextBtn"><i class="fas fa-angle-right"></i></button>
                </div>
            </div>
