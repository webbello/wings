<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/backend/brand/logo1.svg') }}" width="89" height="25" alt="Wings Of Esc">
        <img class="navbar-brand-minimized" src="{{ asset('img/backend/brand/sygnet1.svg') }}" width="30" height="30" alt="Wings">
    </a>
