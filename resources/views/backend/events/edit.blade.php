                    ...
                    <div class="col">
                        <form action="{{ route('admin.events.update',$event->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="summary" value="{{$event->summary}}"/>
                            </div> --}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3 ">
                                    <input type="text" class="form-control datetimepicker" placeholder="Event Name" name="event_date" value="{{$event->event_date}}" aria-label="Recipient's username" aria-describedby="button-addon2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="country" value="{{$event->country}}"/>
                            </div>
                            <div class="form-group">
